...
def gerarPrompt_query(query, nResults, threshold, vector_store):
    ...
    if not relevant_docs:
        ...
        Não parafraseie.
        Em vez de mencionar “SPEAKER(nº)”, refira-se aos falantes como “um determinado indivíduo”, “outro indivíduo”, “uma pessoa”, “o participante”, “uma fonte”, “o interlocutor”, ou outros termos equivalentes, mantendo o sentido de que se trata de pessoas que falaram durante a palestra.
        Pergunta:
        {query}
